...
public class TestaCinema {
    public static void main(String[] args) {
        // 1. Instanciar Filmes
        Filme f1 = new Filme("1", "Batman", 170, 15);
        Filme f2 = new Filme("2", "Duna", 120, 12);

        // 2. Instanciar Sessão (20/07/2026 às 20h00)
        LocalDateTime dataSessao = LocalDateTime.of(2026, 7, 20, 20, 0);
        Sessao sessao1 = new Sessao(101, dataSessao, 1);

        // 3. Agregação: Vincular filme à sessão
        sessao1.vincularFilme(f1);

        // 4. Composição: Vender ingressos
